library Hashtable initializer init
    globals
        ...
        constant integer INDEX = 30
        constant integer INTEGER1 = 31
        constant integer INTEGER2 = 32
        constant integer INTEGER3 = 33
        constant integer REAL1 = 34
        constant integer REAL2 = 35
        constant integer REAL3 = 36
